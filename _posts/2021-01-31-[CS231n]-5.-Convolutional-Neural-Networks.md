...
![6.3.sigmoid](C:\Users\idpjs\Desktop\6.3.sigmoid.jpeg) ![6.3.tanh](C:\Users\idpjs\Desktop\6.3.tanh.jpeg)	

- 왼쪽의 그래프는 시그모이드 함수의 그래프이다.
  - 함수값의 범위가 [0, 1] 사이에 위치한다.
- 오른쪽의 그래프는 tanh 함수의 그래프이다.
...
- **시그모이드(sigmoid) 함수**
  ...
  - zig-zag 형태로 가중치 업데이트가 일어나는 예시를 가져와 보았다.
    ...
    ![dsfa](C:\Users\idpjs\Desktop\dsfa.PNG)
...
- 또 다른 활성화 함수에 대해 알아보자.
  ...
  ![6.3.relu](C:\Users\idpjs\Desktop\6.3.relu.jpeg)
